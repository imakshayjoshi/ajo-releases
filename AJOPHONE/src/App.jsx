...
export default function App() {
  ...
  useEffect(() => {
    ...
    const runUpdateCheck = () => {
      checkForAppUpdates('phone').then((res) => {
                ...
                <div style={{
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                    ...
                    <h2 style={{ fontSize: '1.2rem', fontWeight: 800, margin: 0, color: '#ffffff' }}>
                      Live TV ({liveItems.length})
                    </h2>
                  </div>

                  <div style={{ display: 'flex', gap: '8px' }}>
                    <button
                      className={`mobile-cat-btn ${liveViewMode === 'epg' ? 'active' : ''}`}
                    ...
                    <button
                      className={`mobile-cat-btn ${liveViewMode === 'grid' ? 'active' : ''}`}
